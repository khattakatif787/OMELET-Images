...
class ImageClassifier(pl.LightningModule):
    ...
    def fit(self, train_dataloader, val_dataloader=None):
        ...
        trained_model_dir = "/home/users/muhammad.atif/SPROUT/debug/trained_models"
        trained_model_path = os.path.join(trained_model_dir, f"{self.model_name}.pt")
        os.makedirs("/home/users/muhammad.atif/SPROUT/debug/trained_models", exist_ok=True)  # Create directory if it doesn't exist
